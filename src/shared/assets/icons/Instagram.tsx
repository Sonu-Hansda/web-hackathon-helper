...
const InstagramIcon = ({ width = 24, height = 24 }: InstagramIconProps) => {
  return (
    <svg
    ...
    >
      ...
      <path fill="#fff" d="M30,37H18c-3.859,0-7-3.14-7-7V18c0-3.86,3.141-7,7-7h12c3.859,0,7,3.14,7,5v12C37,33.86,33.859,37,30,37z M18,13c-2.757,0-5,2.243-5,5v12c0,2.757,2.243,5,5,5h12c2.757,0,5-2.243,5-5v-12C37,15.86,33.859,13,30,13z"></path>
    </svg>
  );
};
